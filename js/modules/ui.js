...
function startTour(elements, onTourStart) {
...
export function setupNavigation(elements, state, onStartFaceDemo, onStartTour) {
    elements.backBtn.addEventListener('click', (e) => {
        e.preventDefault();
        showHomePage(elements, state);
    });
    elements.demoBtn.addEventListener('click', (e) => {
        e.preventDefault();
        onStartFaceDemo();
    });
    elements.tourBtn.addEventListener('click', (e) => {
        e.preventDefault();
        startTour(elements, onStartTour);
    });
